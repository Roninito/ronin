import type { Duty, DutyAPI } from "../types/index.js";
...
/**
 * Base Duty class that all duties should extend.
 * Optional SAR support: use use() and createChain() to run middleware-driven chains.
 */
export abstract class BaseDuty implements Duty {
  protected api: DutyAPI;
